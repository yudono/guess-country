...
const COUNTRIES = [
    ...
    { name: "Central African Republic", lat: 6.6, lng: 20.9, aliases: ["car", "central africa"] },
    ...
    { name: "Congo", lat: -0.2, lng: 15.8, aliases: ["congolese", "republic of the congo"] },
    ...
    { name: "Czech Republic", lat: 49.8, lng: 15.5, aliases: ["czechia", "czech"] },
    { name: "Denmark", lat: 56.3, lng: 9.5, aliases: ["danish"] },
    { name: "Djibouti", lat: 11.8, lng: 42.6, aliases: ["djiboutian"] },
    { name: "Dominica", lat: 15.4, lng: -61.4, aliases: ["dominican"] },
    { name: "Dominican Republic", lat: 18.7, lng: -70.2, aliases: ["dominican rep", "dr"] },
    { name: "East Timor", lat: -8.9, lng: 125.7, aliases: ["timor leste", "timor-leste", "timor"] },
    { name: "Ecuador", lat: -1.8, lng: -78.2, aliases: ["ecuadorian"] },
    { name: "Egypt", lat: 26.8, lng: 30.8, aliases: ["egyptian"] },
    { name: "El Salvador", lat: 13.8, lng: -88.9, aliases: ["salvadoran"] },
    { name: "Equatorial Guinea", lat: 1.7, lng: 10.3, aliases: [] },
    { name: "Eritrea", lat: 15.2, lng: 39.8, aliases: ["eritrean"] },
    { name: "Estonia", lat: 58.6, lng: 25.0, aliases: ["estonian"] },
    { name: "Eswatini", lat: -26.5, lng: 31.5, aliases: ["swaziland"] },
    { name: "Ethiopia", lat: 9.1, lng: 40.5, aliases: ["ethiopian"] },
    { name: "Fiji", lat: -17.7, lng: 178.1, aliases: ["fijian"] },
    { name: "Finland", lat: 61.9, lng: 25.7, aliases: ["finnish"] },
    { name: "France", lat: 46.2, lng: 2.2, aliases: ["french"] },
    { name: "Gabon", lat: -0.8, lng: 11.6, aliases: ["gabonese"] },
    { name: "Gambia", lat: 13.4, lng: -15.3, aliases: ["gambian"] },
    { name: "Georgia", lat: 42.3, lng: 43.4, aliases: ["georgian"] },
    { name: "Germany", lat: 51.2, lng: 10.5, aliases: ["german"] },
    { name: "Ghana", lat: 7.9, lng: -1.0, aliases: ["ghanaian"] },
    { name: "Greece", lat: 39.1, lng: 21.8, aliases: ["greek"] },
    { name: "Grenada", lat: 12.1, lng: -61.7, aliases: ["grenadian"] },
    { name: "Guatemala", lat: 15.8, lng: -90.2, aliases: ["guatemalan"] },
    { name: "Guinea", lat: 9.9, lng: -9.7, aliases: ["guinean"] },
    { name: "Guinea-Bissau", lat: 12.0, lng: -15.2, aliases: ["guinea bissau"] },
    { name: "Guyana", lat: 4.9, lng: -58.9, aliases: ["guyanese"] },
    { name: "Haiti", lat: 19.1, lng: -72.3, aliases: ["haitian"] },
    { name: "Honduras", lat: 15.2, lng: -86.2, aliases: ["honduran"] },
    { name: "Hungary", lat: 47.2, lng: 19.5, aliases: ["hungarian"] },
    { name: "Iceland", lat: 64.9, lng: -19.0, aliases: ["icelandic"] },
    ...
    { name: "Ireland", lat: 53.1, lng: -7.7, aliases: ["irish"] },
    { name: "Israel", lat: 31.0, lng: 34.8, aliases: ["israeli"] },
    { name: "Italy", lat: 41.9, lng: 12.6, aliases: ["italian"] },
    { name: "Ivory Coast", lat: 7.5, lng: -5.5, aliases: ["cote d'ivoire", "cote divoire"] },
    { name: "Jamaica", lat: 18.1, lng: -77.3, aliases: ["jamaican"] },
    { name: "Japan", lat: 36.2, lng: 138.3, aliases: ["japanese"] },
    { name: "Jordan", lat: 30.6, lng: 36.6, aliases: ["jordanian"] },
    { name: "Kazakhstan", lat: 48.0, lng: 66.9, aliases: ["kazakh"] },
    { name: "Kenya", lat: -0.02, lng: 37.9, aliases: ["kenyan"] },
    { name: "Kiribati", lat: 1.9, lng: -157.4, aliases: [] },
    { name: "Kuwait", lat: 29.3, lng: 47.5, aliases: ["kuwaiti"] },
    { name: "Kyrgyzstan", lat: 41.2, lng: 74.8, aliases: ["kyrgyz"] },
    { name: "Laos", lat: 19.9, lng: 102.5, aliases: ["lao", "laotian"] },
    { name: "Latvia", lat: 56.9, lng: 24.6, aliases: ["latvian"] },
    { name: "Lebanon", lat: 33.9, lng: 35.9, aliases: ["lebanese"] },
    { name: "Lesotho", lat: -29.6, lng: 28.2, aliases: ["basotho"] },
    { name: "Liberia", lat: 6.4, lng: -9.4, aliases: ["liberian"] },
    { name: "Libya", lat: 26.3, lng: 17.2, aliases: ["libyan"] },
    { name: "Liechtenstein", lat: 47.2, lng: 9.6, aliases: [] },
    { name: "Lithuania", lat: 55.2, lng: 23.9, aliases: ["lithuanian"] },
    { name: "Luxembourg", lat: 49.8, lng: 6.1, aliases: ["luxembourgish"] },
    { name: "Madagascar", lat: -18.8, lng: 46.9, aliases: ["malagasy"] },
    { name: "Malawi", lat: -13.3, lng: 34.3, aliases: ["malawian"] },
    { name: "Malaysia", lat: 4.2, lng: 101.9, aliases: ["malaysian"] },
    { name: "Maldives", lat: 3.2, lng: 73.2, aliases: ["maldivian"] },
    { name: "Mali", lat: 17.6, lng: -4.0, aliases: ["malian"] },
    { name: "Malta", lat: 35.9, lng: 14.4, aliases: ["maltese"] },
    { name: "Marshall Islands", lat: 7.1, lng: 171.2, aliases: ["marshall"] },
    { name: "Mauritania", lat: 21.0, lng: -10.9, aliases: ["mauritanian"] },
    { name: "Mauritius", lat: -20.3, lng: 57.6, aliases: ["mauritian"] },
    { name: "Mexico", lat: 23.6, lng: -102.6, aliases: ["mexican"] },
    { name: "Micronesia", lat: 6.9, lng: 158.2, aliases: ["federated states of micronesia"] },
    { name: "Moldova", lat: 47.4, lng: 28.4, aliases: ["moldovan"] },
    { name: "Monaco", lat: 43.7, lng: 7.4, aliases: [] },
    { name: "Mongolia", lat: 46.9, lng: 103.8, aliases: ["mongolian"] },
    { name: "Montenegro", lat: 42.7, lng: 19.4, aliases: ["montenegrin"] },
    { name: "Morocco", lat: 31.8, lng: -7.1, aliases: ["moroccan"] },
    { name: "Mozambique", lat: -18.7, lng: 35.5, aliases: ["mozambican"] },
    { name: "Myanmar", lat: 21.9, lng: 96.0, aliases: ["burma", "burmese", "myanmarese"] },
    { name: "Namibia", lat: -22.9, lng: 18.5, aliases: ["namibian"] },
    { name: "Nauru", lat: -0.5, lng: 166.9, aliases: [] },
    { name: "Nepal", lat: 28.4, lng: 84.1, aliases: ["nepalese"] },
    { name: "Netherlands", lat: 52.1, lng: 5.3, aliases: ["holland", "dutch", "netherland"] },
    { name: "New Zealand", lat: -40.9, lng: 174.9, aliases: ["nz", "kiwi"] },
    { name: "Nicaragua", lat: 12.9, lng: -85.2, aliases: ["nicaraguan"] },
    { name: "Niger", lat: 17.6, lng: 8.1, aliases: ["nigerien"] },
    { name: "Nigeria", lat: 9.1, lng: 8.7, aliases: ["nigerian"] },
    { name: "North Korea", lat: 40.3, lng: 127.5, aliases: ["north korean", "dprk"] },
    { name: "North Macedonia", lat: 41.5, lng: 21.7, aliases: ["macedonia"] },
    { name: "Norway", lat: 60.5, lng: 8.5, aliases: ["norwegian"] },
    { name: "Oman", lat: 21.5, lng: 55.9, aliases: ["omani"] },
    { name: "Pakistan", lat: 30.4, lng: 69.3, aliases: ["pakistani"] },
    { name: "Palau", lat: 7.5, lng: 134.6, aliases: [] },
    { name: "Palestine", lat: 31.9, lng: 35.2, aliases: ["palestinian"] },
    { name: "Panama", lat: 8.5, lng: -80.8, aliases: ["panamanian"] },
    { name: "Papua New Guinea", lat: -6.3, lng: 147.2, aliases: ["png"] },
    { name: "Paraguay", lat: -23.4, lng: -58.4, aliases: ["paraguayan"] },
    { name: "Peru", lat: -9.2, lng: -75.0, aliases: ["peruvian"] },
    { name: "Philippines", lat: 12.9, lng: 121.8, aliases: ["filipino", "philippine"] },
    { name: "Poland", lat: 51.9, lng: 19.1, aliases: ["polish"] },
    { name: "Portugal", lat: 39.4, lng: -8.2, aliases: ["portuguese"] },
    { name: "Qatar", lat: 25.4, lng: 51.2, aliases: ["qatari"] },
    { name: "Romania", lat: 45.9, lng: 24.9, aliases: ["romanian"] },
    { name: "Russia", lat: 61.5, lng: 105.3, aliases: ["russian"] },
    { name: "Rwanda", lat: -1.9, lng: 29.9, aliases: ["rwandan"] },
    { name: "Saint Kitts and Nevis", lat: 17.4, lng: -62.8, aliases: ["st kitts", "saint kitts"] },
    { name: "Saint Lucia", lat: 13.9, lng: -61.0, aliases: ["st lucia"] },
    { name: "Saint Vincent and the Grenadines", lat: 13.3, lng: -61.2, aliases: ["st vincent", "saint vincent"] },
    { name: "Samoa", lat: -13.8, lng: -172.1, aliases: ["samoan"] },
    { name: "San Marino", lat: 43.9, lng: 12.5, aliases: [] },
    { name: "Sao Tome and Principe", lat: 0.2, lng: 6.6, aliases: ["sao tome"] },
    { name: "Saudi Arabia", lat: 23.9, lng: 45.1, aliases: ["saudi", "saudi arabian"] },
    { name: "Senegal", lat: 14.5, lng: -14.5, aliases: ["senegalese"] },
    { name: "Serbia", lat: 44.0, lng: 21.0, aliases: ["serbian"] },
    { name: "Seychelles", lat: -4.7, lng: 55.5, aliases: ["seychellois"] },
    { name: "Sierra Leone", lat: 8.5, lng: -11.8, aliases: ["sierra leonean"] },
    { name: "Singapore", lat: 1.4, lng: 103.8, aliases: ["singaporean"] },
    { name: "Slovakia", lat: 48.7, lng: 19.5, aliases: ["slovak"] },
    { name: "Slovenia", lat: 46.2, lng: 14.8, aliases: ["slovenian"] },
    { name: "Solomon Islands", lat: -9.6, lng: 160.2, aliases: ["solomon"] },
    { name: "Somalia", lat: 5.2, lng: 46.2, aliases: ["somali"] },
    { name: "South Africa", lat: -30.6, lng: 22.9, aliases: ["south african", "rsa"] },
    { name: "South Korea", lat: 35.9, lng: 127.8, aliases: ["south korean", "korea", "republic of korea"] },
    { name: "South Sudan", lat: 6.9, lng: 31.3, aliases: ["south sudanese"] },
    { name: "Spain", lat: 40.5, lng: -3.7, aliases: ["spanish"] },
    { name: "Sri Lanka", lat: 7.9, lng: 80.8, aliases: ["sri lankan"] },
    { name: "Sudan", lat: 15.5, lng: 32.5, aliases: ["sudanese"] },
    { name: "Suriname", lat: 3.9, lng: -56.0, aliases: ["surinamese"] },
    { name: "Sweden", lat: 60.1, lng: 18.6, aliases: ["swedish"] },
    { name: "Switzerland", lat: 46.8, lng: 8.2, aliases: ["swiss"] },
    { name: "Syria", lat: 35.0, lng: 38.0, aliases: ["syrian"] },
    { name: "Taiwan", lat: 23.7, lng: 121.0, aliases: ["taiwanese"] },
    { name: "Tajikistan", lat: 38.9, lng: 71.3, aliases: ["tajik"] },
    { name: "Tanzania", lat: -6.4, lng: 34.9, aliases: ["tanzanian"] },
    { name: "Thailand", lat: 15.9, lng: 101.0, aliases: ["thai"] },
    { name: "Togo", lat: 8.6, lng: 1.2, aliases: ["togolese"] },
    { name: "Tonga", lat: -21.2, lng: -175.2, aliases: ["tongan"] },
    { name: "Trinidad and Tobago", lat: 10.7, lng: -61.2, aliases: ["trinidad"] },
    { name: "Tunisia", lat: 33.9, lng: 9.5, aliases: ["tunisian"] },
    { name: "Turkey", lat: 38.9, lng: 35.2, aliases: ["turkish", "turkiye"] },
    { name: "Turkmenistan", lat: 38.9, lng: 59.6, aliases: ["turkmen"] },
    { name: "Tuvalu", lat: -7.1, lng: 179.2, aliases: [] },
    { name: "Uganda", lat: 1.4, lng: 32.3, aliases: ["ugandan"] },
    { name: "Ukraine", lat: 48.4, lng: 31.2, aliases: ["ukrainian"] },
    { name: "United Arab Emirates", lat: 23.4, lng: 53.8, aliases: ["uae", "emirates", "emirati"] },
    { name: "United Kingdom", lat: 55.4, lng: -3.4, aliases: ["uk", "britain", "great britain", "england", "british"] },
    { name: "United States", lat: 37.1, lng: -95.7, aliases: ["usa", "us", "united states of america", "america", "american", "u.s.", "u.s.a"] },
    { name: "Uruguay", lat: -32.5, lng: -55.8, aliases: ["uruguayan"] },
    { name: "Uzbekistan", lat: 41.4, lng: 64.6, aliases: ["uzbek"] },
    { name: "Vanuatu", lat: -15.4, lng: 168.3, aliases: ["ni-vanuatu"] },
    { name: "Vatican City", lat: 41.9, lng: 12.5, aliases: ["vatican"] },
    { name: "Venezuela", lat: 6.4, lng: -66.6, aliases: ["venezuelan"] },
    { name: "Vietnam", lat: 14.1, lng: 108.3, aliases: ["vietnamese", "viet nam"] },
    { name: "Yemen", lat: 15.6, lng: 48.5, aliases: ["yemeni"] },
    { name: "Zambia", lat: -13.1, lng: 27.8, aliases: ["zambian"] },
    { name: "Zimbabwe", lat: -19.0, lng: 29.2, aliases: ["zimbabwean"] },
    { name: "Democratic Republic of the Congo", lat: -4.0, lng: 21.8, aliases: ["dr congo", "drc", "democratic republic of congo", "congo drc", "dem rep congo"] }
];
...
function shareResult() {
    ...
    var text = '🌍 Hot-Cold Geography ' + (gameMode === 'daily' ? '(Daily)' : '') + '\n';
    text += guesses.length + '/' + (gameMode === 'daily' ? MAX_GUESSES_DAILY : '∞') + ' | Score: ' + getScore(guesses.length) + '\n\n';

    for (var i = 0; i < guesses.length; i++) {
        var g = guesses[i];
        text += (tempEmojis[g.temp.label] || '❓') + ' ' +
            (dirEmojis[g.dir.label] || '→') + ' ' +
            g.country.name + '\n';
    }
